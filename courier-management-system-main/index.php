...
?>
        <script>
            alert("Oops! Please Enter Your Username and Pswd again..");
...
<body>
    <h1 align='center' style="margin: 15px; color:seagreen;font-weight: bold;font-family:'Times New Roman', Times, serif">COURIER MANAGEMENT SYSTEM</h1>
    <hr />
